...
export type PosicaoPalavra = { palavra: string; linha: number; coluna: number; direcao: "H" | "V" | "D" };
export type GradeCacaPalavras = { tamanho: number; grade: string[][]; posicoes: PosicaoPalavra[] };
