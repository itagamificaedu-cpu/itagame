  ...
  return (
    <main className="min-h-screen bg-neutral-50 px-6 py-10">
      <div className="mx-auto max-w-2xl">
        ...
        <Link
          href="/trilha/prontuario"
          className="mt-3 flex items-center gap-4 rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm transition hover:border-[#1a3fd4] hover:bg-[#1a3fd4]/5"
        >
          <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#1a3fd4]/10 text-xl">
            🩺
          </span>
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 text-sm text-neutral-500">Registre casos clínicos como num sistema de saúde de verdade</p>
          </div>
        </Link>
